...
This section will cover services and technologies that will enable the smooth operation of maintaining the website's infrastructure, development, and content.

\subsection{Cloudflare}
Cloudflare is a company that services and maintains digital internet infrastructure across the globe. Because of this, they also provide backend service products we're particularly interested in, such as their registrar and photo storage.

\subsubsection{Registrar}
Compared to our current registrar GoDaddy, Cloudflare's product named `Registrar' is superior in many ways. Users who want to access the website to view the content will be unaware of this registrar switch – visiting the OMS domain name will still display the same website content before the switch. This is a switch that will make managing the website a simpler ordeal.

\subsubsection{Images}

\subsubsection{Qualities}
The UI/UX of Cloudflare is simple and clear: access to different settings and functions is clearly labeled. In the event that something may be unclear, their online documentation and blog is accessible and digestible for the average layman. The services they provide are robust, dependable, and future-proof because a sizable majority of the internet flows through their worldwide data centers. Simply put, cloud security and internet infrastructure is their domain.

Cloudflare will also be used to host our photo storage. For extra management security, users can enable 2FA.
